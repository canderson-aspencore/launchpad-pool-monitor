...
char organization[] = "vt9jov";
char typeId[] = "ti-cc3200-launch";
char pubtopic[] = "iot-2/evt/status/fmt/json";
char subTopic[] = "iot-2/cmd/+/fmt/json";
char deviceId[] = "209148838dcc";
char clientId[64];
...
char authToken[] = "wiotpcc3200lp1";

MACAddress mac;

// getTemp() and getAcc() functions for cc3200
#include <Wire.h>
#include <BMA222.h>
...
void setup() {
  ...
  bma222.begin();
  xoffset = bma222.readXData();
  yoffset = bma222.readYData();
  zoffset = bma222.readZData();
...
void loop() {
  ...
  char json[100] = "{\"d\":{\"temp\":";

  dtostrf(getTemp(),1,2, &json[13]);
  json[18] = ',';
  getAcc(&json[19]);
...
// getAcc() function for cc3200
void getAcc(char* accDataMsg) {
  double data1 = (double)(bma222.readXData()-xoffset)*0.0156;
  double data2 = (double)(bma222.readYData()-yoffset)*0.0156;
  double data3 = (double)(bma222.readZData()-zoffset)*0.0156;
  sprintf(accDataMsg, "\"AccX\":%.2f,\"AccY\":%.2f,\"AccZ\":%.2f}}\0", data1, data2, data3);
}
